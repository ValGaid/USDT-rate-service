...
const (
	Rates_GetRates_FullMethodName = "/rates.rates/GetRates"
)
...
type RatesClient interface {
	GetRates(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *ratesClient) GetRates(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Response, error) {
...
type RatesServer interface {
	GetRates(context.Context, *Empty) (*Response, error)
...
func (UnimplementedRatesServer) GetRates(context.Context, *Empty) (*Response, error) {
...
func _Rates_GetRates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RatesServer).GetRates(ctx, req.(*Empty))
	}
